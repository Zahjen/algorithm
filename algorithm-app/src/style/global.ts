 ...
 * 
 * @param dir Direction appliqué aux objets, i.e. "row", "column", etc
 ...
 * @param fontSizeText Taille de la police du texte. Elle est posé par défaut à 18.
 * @param textAlign L'alignement du texte
 * @returns Style correspondant à un texte
 */
export const text = (colorText: string = color.text, textAlign: "center" | "auto" | "left" | "right" | "justify" = "justify", fontSizeText: number = fontSize.text): StyleProp<TextStyle> => {
    return {
        color: colorText,
